// src/app/components/thesis-slides/ResearchProblemsSlide.tsx (Updated)
"use client";

import React from "react";
import SlideLayout from "./SlideLayout";
import { SectionGrid, ContentCard, ListItem, HighlightBox, TextContent } from "./SlideContentComponent";
    ...
    >
      <SectionGrid columns={2} className="mb-8 sm:mb-10 lg:mb-12">
        ...
        >
          ...
          <h3 className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-semibold mb-6 text-center leading-relaxed">
      ...
      <HighlightBox variant="primary" className="text-center">
        <h3 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-semibold mb-4 sm:mb-6">Tujuan Penelitian</h3>
        <TextContent size="lg">
