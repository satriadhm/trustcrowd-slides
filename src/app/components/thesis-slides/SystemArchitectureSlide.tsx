      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 xl:gap-12">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-semibold mb-3 sm:mb-4 lg:mb-6 text-[#24ce2a]">Arsitektur Overview</h3>
            
            <div className="bg-gradient-to-br from-blue-900/30 to-purple-900/30 p-3 sm:p-4 lg:p-6 rounded-lg mb-3 sm:mb-4 lg:mb-6">
              <div className="flex items-center justify-center mb-2 sm:mb-3 lg:mb-4">
                <div className="bg-white/10 p-2 sm:p-3 rounded-lg text-[#24ce2a]">
              ...
              <p className="text-center text-sm sm:text-base lg:text-lg text-gray-300 mb-2 sm:mb-3 lg:mb-4">Client-Server dengan GraphQL dan MongoDB</p>
              <div className="flex items-center justify-between">
                ...
                <div className="flex-grow mx-2 sm:mx-3">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-semibold mb-3 sm:mb-4 lg:mb-6 text-[#25da9e]">Komponen Sistem</h3>
            
            <div className="space-y-2 sm:space-y-3 lg:space-y-4">
              <div className="bg-white/5 p-2 sm:p-3 lg:p-4 rounded-lg">
                <div className="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
                  <div className="bg-[#25da9e]/20 p-1 sm:p-2 rounded-full">
              ...
              <div className="bg-white/5 p-2 sm:p-3 lg:p-4 rounded-lg border-2 border-[#24ce2a]/30">
                <div className="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
                  <div className="bg-[#24ce2a]/20 p-1 sm:p-2 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#24ce2a]">
                ...
                <div className="mt-1 sm:mt-2 bg-[#24ce2a]/10 p-1 sm:p-2 rounded">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h3 className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-semibold mb-3 sm:mb-4 lg:mb-6 text-center">Data Flow Process</h3>
          <div className="flex flex-col lg:flex-row items-center justify-between gap-3 sm:gap-4 lg:gap-6">
            <div className="bg-white/5 p-3 sm:p-4 lg:p-6 rounded-lg flex-1">
              <h4 className="font-medium text-base sm:text-lg lg:text-xl xl:text-2xl mb-2 sm:mb-3 text-[#24ce2a] text-center">Input</h4>
            ...
            <div className="mx-1 sm:mx-2 lg:mx-4">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#24ce2a] rotate-90 lg:rotate-0">
            ...
            <div className="bg-white/5 p-3 sm:p-4 lg:p-6 rounded-lg flex-1">
              <h4 className="font-medium text-base sm:text-lg lg:text-xl xl:text-2xl mb-2 sm:mb-3 text-[#25da9e] text-center">Processing</h4>
              <div className="text-sm sm:text-base lg:text-lg text-gray-300 text-center">
                <p>• Dekomposisi M-X</p>
            ...
            <div className="mx-1 sm:mx-2 lg:mx-4">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#25da9e] rotate-90 lg:rotate-0">
                <line x1="5" y1="12" x2="19" y2="12"></line>
                <polyline points="12 5 19 12 12 19"></polyline>
              </svg>
            </div>
            ...
            <div className="bg-white/5 p-3 sm:p-4 lg:p-6 rounded-lg flex-1">
              <h4 className="font-medium text-base sm:text-lg lg:text-xl xl:text-2xl mb-2 sm:mb-3 text-[#24ce2a] text-center">Output</h4>
              <div className="text-sm sm:text-base lg:text-lg text-gray-300 text-center">
