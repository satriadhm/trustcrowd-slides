  ...
  return (
    ...
    >
      ...
      <HighlightBox variant="primary" className="py-6">
        <h3 className="text-xl sm:text-2xl font-semibold mb-4 text-center text-[#24ce2a]">M-X Algorithm: Peer-Consistency Based Quality Control</h3>
      ...
      <SectionGrid columns={2} gap="gap-6">
        <ContentCard title="Prinsip Matematis Inti" animationDelay={0} className="py-6">
          <div className="space-y-4">
            <div className="bg-white/5 p-4 rounded-lg">
              <h4 className="text-base font-medium mb-3 text-[#25da9e]">Agreement Probability Formula</h4>
            ...
            <div className="bg-white/5 p-4 rounded-lg">
              <h4 className="text-base font-medium mb-3 text-[#24ce2a]">Key Variables</h4>
        ...
        <ContentCard title="Implementasi untuk UAT" animationDelay={0.2} className="py-6">
          <div className="space-y-4">
            <div className="bg-white/5 p-4 rounded-lg">
              <h4 className="text-base font-medium mb-3 text-[#24ce2a]">Multiple-Choice Decomposition</h4>
            ...
            <div className="bg-white/5 p-4 rounded-lg">
              <h4 className="text-base font-medium mb-3 text-[#25da9e]">Sliding Window for 3+ Testers</h4>
              <ul className="space-y-2 text-sm">
              ...
              <div className="bg-green-600/20 p-3 rounded-lg mt-3">
      ...
      <HighlightBox variant="secondary" className="py-6">
        <h3 className="text-xl font-semibold mb-4 text-center">Contoh Aplikasi dalam UAT</h3>
        
        <div className="bg-white/5 p-6 rounded-lg">
          <h4 className="font-medium text-base mb-4 text-[#24ce2a]">Skenario: Testing Login Form dengan Gherkin BDD</h4>
          
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white/5 p-4 rounded-lg">
              <h5 className="font-medium text-sm mb-3 text-[#25da9e]">Gherkin Scenario</h5>
            ...
            <div className="bg-white/5 p-4 rounded-lg">
              <h5 className="font-medium text-sm mb-3 text-[#25da9e]">M-X Processing Steps</h5>
      ...
      <HighlightBox variant="primary" className="py-4">
        <h3 className="text-xl font-semibold mb-3 text-center">Focus Penelitian: Validasi M-X dalam UAT Environment</h3>
